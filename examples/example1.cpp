...
double getAbsoluteScale(int frame_id, int sequence_id, double z_cal)
{
  ...
  string line;
  int i = 0;
  ifstream myfile ("/home/jw/SLAM/dataset/poses/00.txt");
  double x =0, y=0, z = 0;
...
int main( int argc, char** argv )
{
  ...
  char filename1[200];
  char filename2[200];
  sprintf(filename1, "/home/jw/SLAM/dataset/sequences/00/image_0/%06d.png", 0);
  sprintf(filename2, "/home/jw/SLAM/dataset/sequences/00/image_0/%06d.png", 1);
  ...
  {
    sprintf(filename, "/home/jw/SLAM/dataset/sequences/00/image_0/%06d.png", numFrame);
    //cout << numFrame << endl;
